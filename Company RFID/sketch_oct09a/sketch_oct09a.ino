...
const char* ssid = "HUAWEI-B310-C10F";
const char* password = "M4J64JDEF4T";
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
void loop() {
  ...
  if (readsuccess) {
    ...
    http.begin(wifiClient, "http://3.144.152.116/IOTims/admin/getUID.php");  //Specify request destination
